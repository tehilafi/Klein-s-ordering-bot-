...
exports.sendWhatsAppResponses = sendWhatsAppResponses;
...
async function sendWhatsAppResponses(phoneNumber, responses) {
...
function toWhatsAppPayload(phoneNumber, response) {
